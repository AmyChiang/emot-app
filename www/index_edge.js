    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid19", tween: [ "style", "${_flash}", "opacity", '0.5', { fromValue: '0'}], position: 879, duration: 0 },
                ...
                { id: "eid25", tween: [ "style", "${_flash}", "opacity", '0.5', { fromValue: '0'}], position: 2246, duration: 0 },
                ...
                { id: "eid45", tween: [ "style", "${_flash2}", "opacity", '0.5', { fromValue: '0'}], position: 341, duration: 0 },
                ...
                { id: "eid48", tween: [ "style", "${_flash2}", "opacity", '0.5', { fromValue: '0'}], position: 1890, duration: 0 },
                ...
                { id: "eid51", tween: [ "style", "${_flash2}", "opacity", '0.47', { fromValue: '0'}], position: 2676, duration: 0 },
                ...
                { id: "eid62", tween: [ "style", "${_flash3}", "opacity", '0.35', { fromValue: '0'}], position: 738, duration: 0 },
                ...
                { id: "eid65", tween: [ "style", "${_flash3}", "opacity", '0.29', { fromValue: '0'}], position: 1173, duration: 0 },
                { id: "eid66", tween: [ "style", "${_flash3}", "opacity", '0', { fromValue: '1'}], position: 1293, duration: 0 },
                { id: "eid83", tween: [ "style", "${_flash3}", "opacity", '0', { fromValue: '0'}], position: 2367, duration: 0 },
                { id: "eid84", tween: [ "style", "${_flash3}", "opacity", '0.3', { fromValue: '0'}], position: 2459, duration: 0 },
                { id: "eid92", tween: [ "style", "${_flash3}", "opacity", '0', { fromValue: '0'}], position: 2616, duration: 0 },
                { id: "eid86", tween: [ "style", "${_flash3}", "opacity", '0', { fromValue: '0'}], position: 3140, duration: 0 },
                { id: "eid87", tween: [ "style", "${_flash3}", "opacity", '0.33', { fromValue: '0'}], position: 3232, duration: 0 },
                { id: "eid88", tween: [ "style", "${_flash3}", "opacity", '0', { fromValue: '0.5'}], position: 3352, duration: 0 },
                { id: "eid4", tween: [ "property", "${_That_Positive_Feeling}", "volume", '0.7', { fromValue: '0.7'}], position: 0, duration: 0 },
                { id: "eid79", tween: [ "property", "${_That_Positive_Feeling}", "volume", '0.516015625', { fromValue: '0.7'}], position: 3181, duration: 0 }            ]
        }
    }
}
};
